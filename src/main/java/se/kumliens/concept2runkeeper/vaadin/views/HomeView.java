...
public class HomeView extends MVerticalLayout implements View {
    ...
    public void init() {
        ...
        MLabel left = new MLabel("This is a tool where you can synchronize your " + link("Concept2 logbook", "http://log.concept2.com/log") + " activities" +
                ...
                " yourself as a user. Then you can give us authorization to read activities from Concept2 and add them as new activites at RunKeeper.").withStyleName(TEXTFIELD_HUGE).withContentMode(HTML).withWidth("100%");
        ...
        MLabel right = new MLabel("This service is still at a very early stage! We currently do not have the possibility to fetch activities" +
                ...
                "download from your Concept2 " + link("history page", "http://log.concept2.com/history") + ".").withStyleName(TEXTFIELD_HUGE).withContentMode(HTML).withWidth("100%");
